...
public class BanhMiActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    FoodAdapter adapter;
    String urlGetdata = Server.DuongdanBanhMi;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) BanhMiActivity.this.getSystemService(Context.SEARCH_SERVICE);
        SearchView searchView = null;
        if (searchManager != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(BanhMiActivity.this.getComponentName()));
