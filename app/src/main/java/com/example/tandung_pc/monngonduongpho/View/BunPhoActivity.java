...
public class BunPhoActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    Toolbar toolbar;
    ListView lv;
    ArrayList<Food> mangfood;
    FoodAdapter adapter;
    String urlGetdata = Server.DuongdanBunPho;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) BunPhoActivity.this.getSystemService(Context.SEARCH_SERVICE);
        SearchView searchView = null;
        if (searchManager != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(BunPhoActivity.this.getComponentName()));
    ...
    private void Anhxa() {
        ...
        lv = findViewById(R.id.listBunPho);
